...
all_trips_q1 <- read.csv("all_trips_2023_q1.csv")
all_trips_q2 <- read.csv("all_trips_2023_q2.csv")
all_trips_q3 <- read.csv("all_trips_2023_q3.csv")
all_trips_q4 <- read.csv("all_trips_2024_q1.csv")
...
aggregate(all_trips$ride_lenght ~ all_trips$member_casual + all_trips$day_of_week, FUN = mean) # nolint
...
AvgDataLenghtFile <- aggregate(all_trips$ride_lenght ~ all_trips$member_casual + all_trips$day_of_week, FUN = mean)
